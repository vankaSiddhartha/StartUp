...
public final class FragmentEventsBinding implements ViewBinding {
  ...
  private FragmentEventsBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView eventRv) {
  ...
  public static FragmentEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.event_rv;
      RecyclerView eventRv = ViewBindings.findChildViewById(rootView, id);
      if (eventRv == null) {
        break missingId;
      }

      return new FragmentEventsBinding((ConstraintLayout) rootView, eventRv);
    }
