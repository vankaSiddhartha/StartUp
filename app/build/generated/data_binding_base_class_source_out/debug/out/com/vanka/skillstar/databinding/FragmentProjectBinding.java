...
public final class FragmentProjectBinding implements ViewBinding {
  ...
  private FragmentProjectBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView projectRv) {
    this.rootView = rootView;
    this.projectRv = projectRv;
  }
  ...
  public static FragmentProjectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.projectRv;
      RecyclerView projectRv = ViewBindings.findChildViewById(rootView, id);
      if (projectRv == null) {
        break missingId;
      }

      return new FragmentProjectBinding((ConstraintLayout) rootView, projectRv);
    }
